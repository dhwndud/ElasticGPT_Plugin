...
@app.get("/search")                       # 'ES' 에서 검색을 실행 하는 ChatGPT 에 노출된 유일한 것 ('Plugin' API)
async def search():
...
@app.get("/Somma-Signature.png")              # 'Plugins' 로고 검색
async def plugin_logo():
  filename = 'Somma-Signature.png'
  return await quart.send_file(filename, mimetype='image/png')


@app.get("/.well-known/ai-plugin.json")       # 'Plugins' manifest 검색
...
@app.get("/openapi.yaml")                     # 'Plugins' OpenAPI 설명을 가져옴.
